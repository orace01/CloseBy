...
import { MarkerSquare, paperShadow, sectionX } from "./common";
      ...
      <div className="mx-auto max-w-[1312px]">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,0.6fr)] lg:items-end lg:gap-16">
          <div className="flex flex-col gap-7">
            <p className="flex items-center gap-2.5 font-mono text-[13px] tracking-[0.06em] text-graphite uppercase">
              <MarkerSquare />
            ...
            >
              ...
              <span className="hl-strong pr-2 pl-1 font-serif font-medium tracking-[-0.03em] italic">sans chercher.</span>
            </h1>
          </div>
          <div className="flex flex-col gap-7 lg:pb-3">
            <p className="text-xl leading-normal text-pretty text-body">
            ...
            <div className="flex flex-wrap gap-2.5">
              <ButtonLink href="/inscription" size="lg">
                Trouver mes clients <ArrowRightIcon size={17} />
              </ButtonLink>
        ...
        <div id="demo" className="mt-16 rounded-t-[28px] bg-desk px-4 pt-8 pb-10 sm:px-10 lg:mt-20 lg:px-16 lg:pt-13 lg:pb-7">
          <p className="flex w-fit flex-wrap items-center gap-x-3 gap-y-1 rounded-3xl bg-paper px-4.5 py-3 text-[15px]">
            ...
            <span className="font-semibold">sites web pour les restaurants, autour de Lyon</span>
          </p>

          <div className="mt-7 grid gap-6 lg:grid-cols-[minmax(0,600px)_minmax(40px,1fr)_minmax(0,440px)] lg:items-start">
            <div className={cn("rounded-[20px] bg-paper px-5 pt-1.5 pb-2.5 sm:px-7", paperShadow)}>
              <div className="flex h-16 items-center justify-between gap-4">
                <span className="text-lg font-semibold">Clients potentiels trouvés</span>
                <span className="hidden font-mono text-[13px] text-graphite sm:inline">38 près de chez vous</span>
              </div>
              <ul>
                {foundClients.map((client) => (
                  <li key={client.name} className="flex min-h-18 items-center gap-4 border-t border-rule-soft py-2">
                    ...
                    <span className="flex h-7.5 shrink-0 items-center gap-1.5 rounded-full bg-success-soft px-3 text-[13px] font-semibold text-success">
            ...
            <div className="hidden justify-center pt-24 lg:flex" aria-hidden="true">
              <svg width="100%" height="16" viewBox="0 0 120 16" preserveAspectRatio="none" fill="none" className="max-w-[120px]">
            ...
            <div className={cn("flex flex-col gap-4.5 bg-paper px-6 py-8 sm:px-8.5 lg:-mt-7", paperShadow)}>
              ...
              <p className="font-serif text-lg leading-[1.6] text-body">
                Bonjour, j’ai vu que <span className="hl">votre menu n’est publié que sur Instagram</span>. Quinze minutes
                pour en parler ?
              </p>
